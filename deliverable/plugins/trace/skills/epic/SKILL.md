...
When the board session ends, open the updated board in the browser with the same command as Phase 3: `node "${CLAUDE_SKILL_DIR}/../../scripts/viewer-open.js" epic "<absolute-home>/.claude/epics/<epic-slug>/epic.md"`.
