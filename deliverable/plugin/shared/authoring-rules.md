...
These rules apply to every file written under the playbook — AGENTS.md files, context files, ADRs, distillation entries, plans, epics, and tickets. They govern what lands on disk, not how the agent talks in the session.
