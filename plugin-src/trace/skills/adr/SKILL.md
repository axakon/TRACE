...
Apply [adr-criteria.md](../../shared/adr-criteria.md), hard gate first. If the decision doesn't clear it, say so and point the developer to `{{skill:trace:distil}}` — don't write a low-value ADR.
